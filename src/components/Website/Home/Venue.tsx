  ...
  const details = [
    {
      icon: MapPin,
      label: "Location",
      value: "Ethereal, Newcastle, KwaZulu-Natal",
    },
    {
      icon: Calendar,
      label: "Date",
    ...
    },
    {
      icon: Clock,
      label: "Time",
      value: "09:00 – 18:00 SAST",
    },
    {
      icon: Users,
      label: "Capacity",
      value: "150 Guests (Invitation Only)",
    },
  ];

  // Replace this with the exact Google Maps share link if you have one
  const mapUrl =
    "https://www.google.com/maps/search/?api=1&query=Ethereal,+Newcastle,+KwaZulu-Natal";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div>
            <div className="bg-gradient-to-br from-white/5 to-white/0 border border-[#d4af37]/50 rounded-2xl backdrop-blur-md shadow-[0_0_40px_rgba(212,175,55,0.1),0_20px_60px_rgba(0,0,0,0.4)] p-9 mb-5">
              <div className="text-[11px] font-bold tracking-[0.2em] text-[#d4af37] uppercase mb-4">
                Venue Details
              </div>
              ...
              {details.map((item, idx) => (
                ...
                >
                  ...
                  <div>
                    <div className="text-[10px] font-bold text-white/35 tracking-[0.15em] uppercase">
                      {item.label}
                    </div>
            ...
            >
              <div className="bg-gradient-to-br from-white/5 to-white/0 border border-white/10 rounded-2xl backdrop-blur-md shadow-[0_20px_60px_rgba(0,0,0,0.3)] overflow-hidden h-[160px] transition-all duration-300 hover:border-[#d4af37] hover:shadow-[0_0_25px_rgba(212,175,55,0.25)] cursor-pointer">
                <div className="w-full h-full bg-gradient-to-br from-[#111827]/80 to-[#0a0a0a]/80 flex items-center justify-center gap-3 px-6">
                  <MapPin
                    size={22}
